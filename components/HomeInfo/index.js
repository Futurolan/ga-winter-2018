      ...
      <div className='container'>
        ...
        <div className='columns is-variable is-8 is-centered'>
          <div className='column is-one-quarter'>
            <h3 className='title has-text-weight-bold has-text-white'>Nouvelle édition</h3>
          ...
          <div className='column is-one-quarter'>
            <h3 className='title has-text-weight-bold has-text-white'>Inscriptions</h3>
            <p className='content has-text-white'>
            Les inscriptions pour la Gamers Assembly 2018 ouvriront le <b>22 décembre 2017 à 20h</b>
            </p>
          </div>
          <div className='column is-one-quarter'>
            <h3 className='title has-text-weight-bold has-text-white'>Réseaux sociaux</h3>
            <p className='content has-text-white'>
            Rejoignez-nous !<br />
